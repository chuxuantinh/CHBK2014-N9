...
namespace CHBK2014_N9.Class
{
    ...
    class DanhMuc_CaLamViec
    {
        ...
        public DataTable CT_SHIFT_GetList()
        {
            string procname = "CT_SHIFT_GetList";
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@EndTime", EndTime);
                db.AddParameter("@Description", Description);
                db.ExecuteNonQueryWithTransaction("CT_SHIFT_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@ShiftCode", ShiftCode);
                db.ExecuteNonQueryWithTransaction("CT_SHIFT_Delete");
                db.CommitTransaction();
