...
namespace CHBK2014_N9.Class
{
    class DanhMuc_TinHoc
    {
        ...
        {
            string procname = "CT_INFORMATIC_GetList";
        ...
        {
            string procname = "CT_INFORMATIC_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_INFORMATIC_Insert");
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@Description", Description);
                db.AddParameter("@Active", Active);
                db.ExecuteNonQueryWithTransaction("CT_INFORMATIC_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@InformaticCode", InformaticCode);
                db.ExecuteNonQueryWithTransaction("CT_INFORMATIC_Delete");
                db.CommitTransaction();
