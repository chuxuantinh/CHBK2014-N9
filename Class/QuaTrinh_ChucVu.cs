...
namespace CHBK2014_N9.Class
{
     public class QuaTrinh_ChucVu
    {
        ...
        #endregion
        public DataTable CT_PROCESS_POSITION_GetListByEmployee()
        {
            string procname = "CT_PROCESS_POSITION_GetListByEmployee";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@EmployeeCode", Class.App._manv);
            return db.ExecuteDataTable(procname);
        }
        public DataTable CT_PROCESS_POSITION_Get()
        {
            string procname = "CT_PROCESS_POSITION_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_PROCESS_POSITION_Insert");
                //db.CreateNewSqlCommand();
                //db.AddParameter("@EmployeeCode", EmployeeCode);
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@PositionID", PositionID);
                db.ExecuteNonQueryWithTransaction("CT_PROCESS_POSITION_Delete");
                db.CommitTransaction();
