   ...
   public class QuaTrinh_DaoTao
    {
        ...
        #endregion
        public DataTable CT_PROCESS_TRAINING_GetListByEmployee()
        {
            string procname = "CT_PROCESS_TRAINING_GetListByEmployee";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@EmployeeCode", Class.App._manv);
            return db.ExecuteDataTable(procname);
        }
        public DataTable CT_PROCESS_TRAINING_Get()
        {
            string procname = "CT_PROCESS_TRAINING_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_PROCESS_TRAINING_Insert");
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@TrainingID", TrainingID);
                db.ExecuteNonQueryWithTransaction("CT_PROCESS_TRAINING_Delete");
                db.CommitTransaction();
