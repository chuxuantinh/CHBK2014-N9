...
namespace CHBK2014_N9.Class
{
    class DanhMuc_NgoaiNgu
    {
        ...
        {
            string procname = "CT_LANGUAGE_GetList";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_LANGUAGE_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_LANGUAGE_Insert");
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@Description", Description);
                db.AddParameter("@Active", Active);
                db.ExecuteNonQueryWithTransaction("CT_LANGUAGE_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@LanguageCode", LanguageCode);
                db.ExecuteNonQueryWithTransaction("CT_LANGUAGE_Delete");
                db.CommitTransaction();
