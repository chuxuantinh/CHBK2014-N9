...
namespace CHBK2014_N9.Class
{
    public class NhanVien
    {
        ...
        {
            string Proced = "CT_EMPLOYEE_GetList";
        ...
        {
            string procname = "CT_EMPLOYEE_GetListByDepartment";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_EMPLOYEE_GetListByDepartment_Ex";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@DepartmentCode", DepartmentCode);
            db.AddParameter("@Status", Status);
        ...
        public DataTable LoadDanhSachNhanVien()
        {
            string procname = "CT_EMPLOYEE_GetList";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@Status", Status);
            db.AddParameter("@DayFirstMonth", DateTime.Now);
        ...
        {
            string procname = "CT_EMPLOYEE_GetList_Basic";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@Status", Status);
            db.AddParameter("@DayFirstMonth", DateTime.Now);
        ...
        {
            string procname = "CT_EMPLOYEE_GetList_Ex";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@Status", Status);
            db.AddParameter("@DayFirstMonth", DateTime.Now);
        ...
        public DataTable CT_EMPLOYEE_CheckIDCard()
        {
            string procname = "CT_EMPLOYEE_CheckIDCard";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_EMPLOYEE_GetListByBranch";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_EMPLOYEE_GetListByGroup";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_EMPLOYEE_GetListByGroup_Ex";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@GroupCode", GroupCode);
            db.AddParameter("@Status", Status);
        ...
        {
            string procname = "CT_EMPLOYEE_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public DataTable CT_EMPLOYEE_GetByEnroll(string strCode)
        {
            string procname = "CT_EMPLOYEE_GetByEnroll";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_EMPLOYEE_DEGREE_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public DataTable CT_EMPLOYEE_GetByEnroll()
        {
            string procname = "CT_EMPLOYEE_GetByEnroll";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool CT_EMPLOYEE_UpdateEnrollNumber()
        {
            DbAccess db = new DbAccess();
            db.BeginTransaction();
            try
            {
                ...
                db.AddParameter("@EmployeeCode", EmployeeCode);
                db.AddParameter("@EnrollNumber", EnrollNumber);
                db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_UpdateEnrollNumber");
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@EmployeeCode", EmployeeCode);
                db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_Delete");
        ...
        public string GetNewCode()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    case 1:
                        return "CT000" + next_id.ToString();
                    case 2:
                        return "CT00" + next_id.ToString();
                    case 3:
                        return "CT0" + next_id.ToString();
                    case 4:
                        return "CT" + next_id.ToString();
                }
            }
            return "CT0001";
        ...
        public bool Insert(DataTable DataDegree)
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_Insert");
                ...
                for (int i = 0; i < DataDegree.Rows.Count; i++)
                {
                    ...
                    db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_DEGREE_Insert");
                }
                ...
                if (IsHopDong)
                {
                    ...
                    if (Status == 3) // 
                    {
                        if (StopWorkCode.Length != 0)
                        {
                            ...
                            db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_DEACTIVE_Insert");
                        }
                    }
                }
        ...
        public bool Update(DataTable DataDegree)
        {
            ...
            try
            {
                ...
                db.AddParameter("@Password", Password);
                db.AddParameter("@Description", Description);
                db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_Update");

                // truoc khi cap nhat bang cap thi xoa het luon
                db.CreateNewSqlCommand();
                db.AddParameter("@EmployeeCode", EmployeeCode);
                db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_DEGREE_Delete_Ta");
                ///
                for (int i = 0; i < DataDegree.Rows.Count; i++)
                {
                    db.CreateNewSqlCommand();
            ...
            try
            {
                for (int i = 0; i < Data.Rows.Count; i++)
                {
                    if ((bool)Data.Rows[i]["Chon"] == true)
                    {
                        ...
                        db.AddParameter("@IDCardPlace", IDCardPlace);
                        db.AddParameter("@Status", Status);
                        db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_Import");
                    }
                }
                db.CreateNewSqlCommand();
                db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_Count");
        ...
        public bool CT_EMPLOYEE_Update_DepartmentFast(object[] EmCode)
        {
            DbAccess db = new DbAccess();
            db.BeginTransaction();
            try
            {
                ...
                for (int i = 0; i < EmCode.Length; i++)
                {
                    ...
                    db.AddParameter("@DepartmentCode", DepartmentCode);
                    db.AddParameter("@GroupCode", GroupCode);
                    db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_Update_DepartmentFast");
        ...
        public bool CT_EMPLOYEE_Update_PositionFast(object[] EmCode)
        {
            DbAccess db = new DbAccess();
            db.BeginTransaction();
            try
            {
                ...
                for (int i = 0; i < EmCode.Length; i++)
                {
                    ...
                    db.AddParameter("@EmployeeCode", EmCode[i].ToString());
                    db.AddParameter("@Position", Position);
                    db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_Update_PositionFast");
                    DanhSach += EmCode[i].ToString() + ',';
                }
                db.CreateNewSqlCommand();
                db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_Count");
