...
namespace CHBK2014_N9.Class
{
    public class DanhMuc_HopDong
    {
        ...
        public DataTable CT_CONTRACT_GetListByBranch()
        {
            string procname = "CT_CONTRACT_GetListByBranch";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@BranchCode", BranchCode);
            return db.ExecuteDataTable(procname);
        }
        public DataTable CT_CONTRACT_GetCurrentListByEmployee()
        {
            string procname = "CT_CONTRACT_GetCurrentListByEmployee";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public DataTable CT_CONTRACT_GetList()
        {
            string procname = "CT_CONTRACT_GetList";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            return db.ExecuteDataTable(procname);
        }
        ...
        public DataTable CT_CONTRACT_GetListExpiration()
        {
            string procname = "CT_CONTRACT_GetListExpiration";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            return db.ExecuteDataTable(procname);
        }
        public DataTable CT_CONTRACT_GetListJustExpiration()
        {
            string procname = "CT_CONTRACT_GetListJustExpiration";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            return db.ExecuteDataTable(procname);
        }

        public DataTable CT_CONTRACT_GetListByDepartment()
        {
            string procname = "CT_CONTRACT_GetListByDepartment";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public DataTable CT_CONTRACT_GetListByGroup()
        {
            string procname = "CT_CONTRACT_GetListByGroup";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public DataTable CT_CONTRACT_GetByEmployee()
        {
            string procname = "CT_CONTRACT_GetByEmployee";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@EmployeeCode", EmployeeCode);
            return db.ExecuteDataTable(procname);
        }
        public DataTable CT_CONTRACT_Get(string strCode)
        {
            string procname = "CT_CONTRACT_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public DataTable CT_CONTRACT_GetByYear()
        {
            string procname = "CT_CONTRACT_GetByYear";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_CONTRACT_Insert");
