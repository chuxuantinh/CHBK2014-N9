...
public    class DanhMuc_Nhom
    {
        ...
        {
            string procname = "CT_GROUP_GetList";
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_GROUP_Insert");
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@FactQuantity", FactQuantity);
                db.AddParameter("@Description", Description);
                db.ExecuteNonQueryWithTransaction("CT_GROUP_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@GroupCode", GroupCode);
                db.ExecuteNonQueryWithTransaction("CT_GROUP_Delete");
                db.CommitTransaction();
