...
namespace CHBK2014_N9.Class
{
    public class DanhMuc_Quyen
    {
        ...
        {
            string procname = "CT_OBJECT_GetList";
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_OBJECT_Insert");
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@ID", ID);
                db.ExecuteNonQueryWithTransaction("CT_OBJECT_Delete");
                db.CommitTransaction();
                return true;
            }
            catch (Exception ex)
