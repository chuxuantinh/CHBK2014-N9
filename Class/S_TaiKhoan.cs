  ...
  public class S_TaiKhoan
    {
        ...
        public DataTable GetAllList_USER()
        {
            ...
            string procname = "CT_USER_GetList";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            return db.ExecuteDataTable(procname);
        }
        ...
        {
            string procname = "CT_USER_RULE_GetListByUsername";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@UserName", UserName);
        ...
        {
            string procname = "CT_OBJECT_NotUseByUsername";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@UserName", UserName);
            DataTable dt = db.ExecuteDataTable(procname);
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_USER_Insert");
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@Description", Description);
                db.AddParameter("@Active", Active);
                db.ExecuteNonQueryWithTransaction("CT_USER_Update");
                db.CommitTransaction();
                return true;
            }
            catch (Exception ex)
            ...
            try
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    if ((bool)dt.Rows[i]["selectvalue"] == true)
                    {
                        ...
                        db.ExecuteNonQueryWithTransaction("CT_USER_RULE_Insert");
                    }
                }
                db.CommitTransaction();
                return true;
        ...
        public bool ChangePassword()
        {
            ...
            try
            {
                ...
                db.AddParameter("@UserName", UserName);
                db.AddParameter("@Password", Password);
                db.ExecuteNonQueryWithTransaction("CT_USER_ChangePassword");
                db.CommitTransaction();
