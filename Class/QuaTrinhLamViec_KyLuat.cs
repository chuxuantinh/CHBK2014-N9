...
namespace CHBK2014_N9.Class
{
   public class QuaTrinhLamViec_KyLuat
   {
       ...
       public DataTable CT_PROCESS_DISCIPLINE_GetListByEmployee()
       {
           string procname = "CT_PROCESS_DISCIPLINE_GetListByEmployee";
           DbAccess db = new DbAccess();
           db.CreateNewSqlCommand();
           db.AddParameter("@EmployeeCode", Class.App._manv);
           return db.ExecuteDataTable(procname);
       }
       public DataTable CT_PROCESS_DISCIPLINE_Get()
       {
           string procname = "CT_PROCESS_DISCIPLINE_Get";
           DbAccess db = new DbAccess();
           db.CreateNewSqlCommand();
       ...
       public bool Insert()
       {
           ...
           try
           {
               ...
               db.ExecuteNonQueryWithTransaction("CT_PROCESS_DISCIPLINE_Insert");
       ...
       public bool Update()
       {
           ...
           try
           {
               ...
               db.AddParameter("@Person", Person);
               db.AddParameter("@FilePath", "");
               db.ExecuteNonQueryWithTransaction("CT_PROCESS_DISCIPLINE_Update");
               db.CommitTransaction();
