...
namespace CHBK2014_N9.Class
{
   public class QuaTrinhLamViec_KhenThuong
   {
       ...
       public DataTable CT_PROCESS_REWARD_GetListByEmployee()
       {
           string procname = "CT_PROCESS_REWARD_GetListByEmployee";
           DbAccess db = new DbAccess();
           db.CreateNewSqlCommand();
           db.AddParameter("@EmployeeCode", Class.App._manv);
           return db.ExecuteDataTable(procname);
       }
       public DataTable CT_PROCESS_REWARD_Get()
       {
           string procname = "CT_PROCESS_REWARD_Get";
           DbAccess db = new DbAccess();
           db.CreateNewSqlCommand();
       ...
       public bool Update()
       {
           ...
           try
           {
               ...
               db.ExecuteNonQueryWithTransaction("CT_PROCESS_REWARD_Update");
               db.CommitTransaction();
       ...
       public bool Delete()
       {
           ...
           try
           {
               db.CreateNewSqlCommand();
               db.AddParameter("@RewardID", RewardID);
               db.ExecuteNonQueryWithTransaction("CT_PROCESS_REWARD_Delete");
               db.CommitTransaction();
