...
namespace CHBK2014_N9.Class
{
    public class BangXepCa
    {
        ...
        public DataTable CT_TIMEKEEPER_SHIFT_GetList()
        {
            string procname = "CT_TIMEKEEPER_SHIFT_GetList";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public DataTable CT_TIMEKEEPER_SHIFT_GetListByBranch()
        {
            string procname = "CT_TIMEKEEPER_SHIFT_GetListByBranch";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@TimeKeeperTableListID", TimeKeeperTableListID);
        ...
        public DataTable CT_TIMEKEEPER_SHIFT_GetListByDepartment()
        {
            string procname = "CT_TIMEKEEPER_SHIFT_GetListByDepartment";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@TimeKeeperTableListID", TimeKeeperTableListID);
        ...
        public DataTable CT_TIMEKEEPER_SHIFT_GetListByEmployee()
        {
            string procname = "CT_TIMEKEEPER_SHIFT_GetListByEmployee";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@TimeKeeperTableListID", TimeKeeperTableListID);
        ...
        public DataTable CT_TIMEKEEPER_TABLELIST_GetByID()
        {
            string procname = "CT_TIMEKEEPER_TABLELIST_GetByID";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@TimeKeeperTableListID", TimeKeeperTableListID);
            DataTable dt = db.ExecuteDataTable(procname);
        ...
        public bool CT_TIMEKEEPER_SHIFT_UpdateFromOld()
        {
            DbAccess db = new DbAccess();
            db.BeginTransaction();
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_TIMEKEEPER_SHIFT_UpdateFromOld");
                db.CommitTransaction();
                return true;
            }
            catch (Exception ex)
