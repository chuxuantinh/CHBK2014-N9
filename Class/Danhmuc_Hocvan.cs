...
namespace CHBK2014_N9.Class
{
    class Danhmuc_Hocvan
    {
        ...
        {
            string procname = "CT_EDUCATION_GetList";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_EDUCATION_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_EDUCATION_Insert");
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@Description", Description);
                db.AddParameter("@Active", Active);
                db.ExecuteNonQueryWithTransaction("CT_EDUCATION_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@EducationCode", EducationCode);
                db.ExecuteNonQueryWithTransaction("CT_EDUCATION_Delete");
                db.CommitTransaction();
