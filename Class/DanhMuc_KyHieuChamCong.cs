...
{
 public   class DanhMuc_KyHieuChamCong
    {
        ...
        public DataTable CT_SYMBOL_GetList()
        {
            string procname = "CT_SYMBOL_GetList";
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@IsEdit", IsEdit);
                db.AddParameter("@Description", Description);
                db.ExecuteNonQueryWithTransaction("CT_SYMBOL_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@SymbolCode", SymbolCode);
                db.ExecuteNonQueryWithTransaction("CT_SYMBOL_Delete");
                db.CommitTransaction();
