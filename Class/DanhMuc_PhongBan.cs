   ...
   public class DanhMuc_PhongBan
    {
        ...
        {
            string procname = "CT_DEPARTMENT_GetListByBranch";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_GROUP_GetListByDepartment";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_DEPARTMENT_GetList";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            return db.ExecuteDataTable(procname);
        }
        ...
        {
            string procname = "CT_DEPARTMENT_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_DEPARTMENT_Insert");
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@DepartmentCode", DepartmentCode);
                db.ExecuteNonQueryWithTransaction("CT_DEPARTMENT_Delete");
                db.CommitTransaction();
