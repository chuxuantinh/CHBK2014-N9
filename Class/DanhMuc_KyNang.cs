...
public class DanhMuc_KyNang
...

    {
        ...
        {
            string procname = "CT_SKILL_GetList";
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_SKILL_Insert");
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@Description", Description);
                db.AddParameter("@Active", Active);
                db.ExecuteNonQueryWithTransaction("CT_SKILL_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@SkillCode", SkillCode);
                db.ExecuteNonQueryWithTransaction("CT_SKILL_Delete");
                db.CommitTransaction();
