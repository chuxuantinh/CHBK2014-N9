...
namespace CHBK2014_N9.Class
{
    class DanhMuc_ThietBiChamCong
    {
        ...
        public DataTable CT_MACHINE_GetList()
        {
            string procname = "CT_MACHINE_GetList";
        ...
        {
            string procname = "CT_MACHINE_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@Password", Password);
                db.AddParameter("@Com", Com);
                db.ExecuteNonQueryWithTransaction("CT_MACHINE_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@MachineCode", MachineCode);
                db.ExecuteNonQueryWithTransaction("CT_MACHINE_Delete");
                db.CommitTransaction();
