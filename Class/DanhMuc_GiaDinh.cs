...
namespace CHBK2014_N9.Class
{
    public class DanhMuc_GiaDinh
    {
        ...
        {
            string procname = "CT_RELATIVE_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_RELATIVE_Insert");
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@Description", Description);
                db.AddParameter("@Active", Active);
                db.ExecuteNonQueryWithTransaction("CT_RELATIVE_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@RelativeCode", RelativeCode);
                db.ExecuteNonQueryWithTransaction("CT_RELATIVE_Delete");
                db.CommitTransaction();
