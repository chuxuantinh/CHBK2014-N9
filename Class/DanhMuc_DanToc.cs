...
namespace CHBK2014_N9.Class
{
    class DanhMuc_DanToc
    {
        ...
        {
            string procname = "CT_ETHNIC_GetList";
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_ETHNIC_Insert");
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@EthnicCode", EthnicCode);
                db.ExecuteNonQueryWithTransaction("CT_ETHNIC_Delete");
                db.CommitTransaction();
