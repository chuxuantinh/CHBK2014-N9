...
namespace CHBK2014_N9.Class
{
    public class DanhMuc_BenhVien
    {
        ...
        public DataTable GetAllList_HOSPITAL()
        {
            ...
            string procname = "CT_HOSPITAL_GetList";
        ...
        {
            string procname = "CT_HOSPITAL_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        {
            string procname = "CT_HOSPITAL_GetListByProvince";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Insert()
        {
            ...
            try
            {
                ...
                db.ExecuteNonQueryWithTransaction("CT_HOSPITAL_Insert");
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@HospitalCode", HospitalCode);
                db.ExecuteNonQueryWithTransaction("CT_HOSPITAL_Delete");
                db.CommitTransaction();
