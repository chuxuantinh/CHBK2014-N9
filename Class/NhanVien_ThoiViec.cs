    ...
    class NhanVien_ThoiViec
    {
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@EmployeeCode", EmployeeCode);
                db.AddParameter("@Year", Year);
                db.ExecuteNonQueryWithTransaction("CT_EMPLOYEE_DEACTIVE_Update");
                db.CommitTransaction();
                return true;
            }
            catch (Exception ex)
        ...
        public DataTable CT_EMPLOYEE_DEACTIVE_GetPrint()
        {
            string procname = "CT_EMPLOYEE_DEACTIVE_GetPrint";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
            db.AddParameter("@EmployeeCode", EmployeeCode);
            return db.ExecuteDataTable(procname);
