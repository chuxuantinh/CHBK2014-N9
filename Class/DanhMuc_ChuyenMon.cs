...
namespace CHBK2014_N9.Class
{
    class DanhMuc_ChuyenMon
    {
        ...
        {
            string procname = "CT_PROFESSIONAL_Get";
            DbAccess db = new DbAccess();
            db.CreateNewSqlCommand();
        ...
        public bool Update()
        {
            ...
            try
            {
                ...
                db.AddParameter("@Description", Description);
                db.AddParameter("@Active", Active);
                db.ExecuteNonQueryWithTransaction("CT_PROFESSIONAL_Update");
                db.CommitTransaction();
        ...
        public bool Delete()
        {
            ...
            try
            {
                db.CreateNewSqlCommand();
                db.AddParameter("@ProfessionalCode", ProfessionalCode);
                db.ExecuteNonQueryWithTransaction("CT_PROFESSIONAL_Delete");
                db.CommitTransaction();
