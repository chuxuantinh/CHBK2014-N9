...
namespace CHBK2014_N9
{
    public partial class frmQuaTrinhLamViec_DaoTao_Update : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void call_info(string Form_name, string code)
        {
            ...
            DataTable dt = dtao.CT_PROCESS_TRAINING_Get();
        ...
        private void Update_DaoTao()
        {
            ...
            (this.Owner as frmQuaTrinhLamViec_DaoTao).CT_PROCESS_TRAINING_GetListByEmployee();
        ...
        private void frmQuaTrinhLamViec_DaoTao_Update_Load(object sender, EventArgs e)
        {
