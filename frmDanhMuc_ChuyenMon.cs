...
{
    public partial class frmDanhMuc_ChuyenMon :DevExpress.XtraEditors.XtraForm
    {
        public frmDanhMuc_ChuyenMon()
        {
            InitializeComponent();
        }

        private void frmDanhMuc_ChuyenMon_Load(object sender, EventArgs e)
        {
        ...
        {
            frmDanhmuc_Update frm = new frmDanhmuc_Update(true, "Thêm Chuyên môn", "CM", null, "frmDanhMuc_ChuyenMon");
            frm.Owner = this;
            frm.ShowDialog();
        }
        ...
        private void btnEdit_ItemClick_1(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (SelectedRow >= 0)
            {
                ...
                frmDanhmuc_Update frm = new frmDanhmuc_Update(false, "Sửa Chuyên môn", "CM", _value, "frmDanhMuc_ChuyenMon");
                frm.Owner = this;
                frm.ShowDialog();
            }
        }
        ...
        private void btnAdd_ItemClick_2(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            frmDanhmuc_Update frm = new frmDanhmuc_Update(true, "Thêm Chuyên môn", "CM", null, "frmDanhMuc_ChuyenMon");
            frm.Owner = this;
            frm.ShowDialog();  
        ...
        private void btnEdit_ItemClick_2(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (!btnEdit.Enabled)
                return;
            int SelectedRow = gridItemDetail.FocusedRowHandle;
