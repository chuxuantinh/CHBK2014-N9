...
{
    public partial class xfmRelative : Form
    {
        ...
        public xfmRelative(bool search)
        {
            this._search = search;
        ...
        public event xfmRelative.ItemSelectedEventHander ItemSelected;

        public delegate void ItemSelectedEventHander(object sender, DIC_RELATIVE item);
    }
}
