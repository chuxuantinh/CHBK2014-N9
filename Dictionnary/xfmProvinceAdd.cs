...
{
    public partial class xfmProvinceAdd : XtraForm
    {
        public RowClickEventArgs m_RowClickEventArgs;
        public xfmProvinceAdd()
        {
            InitializeComponent();
        }


        public xfmProvinceAdd(Actions Action)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            DIC_PROVINCE dICPROVINCE = new DIC_PROVINCE();
            this.ucAdd.SetData(dICPROVINCE.NewID());
            this.Text = "Thêm";
        }

        public xfmProvinceAdd(Actions Action, DIC_PROVINCE Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.ProvinceCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucProvinceAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        public void RaiseAddedEventHander(DIC_PROVINCE Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_PROVINCE Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_PROVINCE Item)
        {
        ...
        public event xfmProvinceAdd.AddedEventHander Added;

        public event xfmProvinceAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_PROVINCE Item);

        public delegate void UpdatedEventHander(object sender, DIC_PROVINCE Item);
    }
}
