...
{
    public partial class xfmShiftAdd : XtraForm
    {
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucShiftAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        public event xfmShiftAdd.AddedEventHander Added;

        public event xfmShiftAdd.UpdatedEventHander Updated;
