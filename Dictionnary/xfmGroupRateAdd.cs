...
{
    public partial class xfmGroupRateAdd : Form
    {
        public RowClickEventArgs m_RowClickEventArgs;
        public xfmGroupRateAdd()
        {
            InitializeComponent();
        }
        ...
        public xfmGroupRateAdd(Actions Action)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            DIC_GROUP_RATE dICGROUPRATE = new DIC_GROUP_RATE();
            this.ucAdd.SetData(dICGROUPRATE.NewID());
            this.Text = "Thêm";
        }

        public xfmGroupRateAdd(Actions Action, DIC_GROUP_RATE Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.GroupRateCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucGroupRateAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        public void RaiseAddedEventHander(DIC_GROUP_RATE Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_GROUP_RATE Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_GROUP_RATE Item)
        {
        ...
        public event xfmGroupRateAdd.AddedEventHander Added;

        public event xfmGroupRateAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_GROUP_RATE Item);

        public delegate void UpdatedEventHander(object sender, DIC_GROUP_RATE Item);
    }
}
