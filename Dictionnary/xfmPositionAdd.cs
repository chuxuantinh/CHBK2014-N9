...
{
    public partial class xfmPositionAdd : XtraForm
    {

        public RowClickEventArgs m_RowClickEventArgs;
   
        public xfmPositionAdd()
        {
            InitializeComponent();
        }


        public xfmPositionAdd(Actions Action)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            DIC_POSITION dICPOSITION = new DIC_POSITION();
          this.ucAdd.SetData(dICPOSITION.NewID());
            this.Text = "Thêm";
        }

        public xfmPositionAdd(Actions Action, DIC_POSITION Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.PositionCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucPositionAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        public void RaiseAddedEventHander(DIC_POSITION Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_POSITION Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_POSITION Item)
        {
        ...
        public event xfmPositionAdd.AddedEventHander Added;

        public event xfmPositionAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_POSITION Item);

        public delegate void UpdatedEventHander(object sender, DIC_POSITION Item);
    }
}
