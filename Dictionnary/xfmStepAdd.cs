...
{
    public partial class xfmStepAdd : XtraForm
    {
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucStepAdd.SuccessEventHander(this.ucAdd_Success);
            this.Text = "Bậc lương";
        }
        ...
        public void RaiseAddedEventHander(DIC_SALARY_STEP Item)
        {
            if (this.Added != null)
            {
        ...
        public event xfmStepAdd.AddedEventHander Added;

        public event xfmStepAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_SALARY_STEP Item);

        public delegate void UpdatedEventHander(object sender, DIC_SALARY_STEP Item);
    }
}
