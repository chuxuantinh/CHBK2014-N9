...
{
    public partial class xfmEthnicAdd : Form
    {
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucEthnicAdd.SuccessEventHander(this.ucAdd_Success);
            this.Text = "Dân tộc";
        }
        ...
        public void RaiseAddedEventHander(DIC_ETHNIC Item)
        {
            if (this.Added != null)
            {
        ...
        public event xfmEthnicAdd.AddedEventHander Added;

        public event xfmEthnicAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_ETHNIC Item);

        public delegate void UpdatedEventHander(object sender, DIC_ETHNIC Item);
