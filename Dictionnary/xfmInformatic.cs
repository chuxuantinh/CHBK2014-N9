...
{
    public partial class xfmInformatic : XtraForm
    {
        ...
        public xfmInformatic(bool search)
        {
            this._search = search;
        ...
        public event xfmInformatic.ItemSelectedEventHander ItemSelected;

        public delegate void ItemSelectedEventHander(object sender, DIC_INFORMATIC item);
    }
}
