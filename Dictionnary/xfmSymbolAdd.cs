...
{
    public partial class xfmSymbolAdd : XtraForm
    {
        ...
        public xfmSymbolAdd(Actions Action, DIC_SYMBOL Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.SymbolCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucSymbolAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        private void ucAdd_Success(object sender, DIC_SYMBOL Item)
        {
        ...
        public event xfmSymbolAdd.AddedEventHander Added;

        public event xfmSymbolAdd.UpdatedEventHander Updated;
