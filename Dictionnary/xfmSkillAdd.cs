...
{
    public partial class xfmSkillAdd : XtraForm
    {
        ...
        public xfmSkillAdd(Actions Action)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            DIC_SKILL dICSKILL = new DIC_SKILL();
            this.ucAdd.SetData(dICSKILL.NewID());
            this.Text = "Thêm";
        }

        public xfmSkillAdd(Actions Action, DIC_SKILL Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.SkillCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucSkillAdd.SuccessEventHander(this.ucAdd_Success);
            this.Text = "";
        }
        ...
        public void RaiseAddedEventHander(DIC_SKILL Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_SKILL Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_SKILL Item)
        {
        ...
        public event xfmSkillAdd.AddedEventHander Added;

        public event xfmSkillAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_SKILL Item);

        public delegate void UpdatedEventHander(object sender, DIC_SKILL Item);
