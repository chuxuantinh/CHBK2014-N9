...
{
    public partial class xfmProfessionalAdd : XtraForm
    {

        public RowClickEventArgs m_RowClickEventArgs;
        public xfmProfessionalAdd()
        {
            InitializeComponent();
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucProfessionalAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        public void RaiseAddedEventHander(DIC_PROFESSIONAL Item)
        {
            if (this.Added != null)
            {
        ...
        public event xfmProfessionalAdd.AddedEventHander Added;

        public event xfmProfessionalAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_PROFESSIONAL Item);

        public delegate void UpdatedEventHander(object sender, DIC_PROFESSIONAL Item);
