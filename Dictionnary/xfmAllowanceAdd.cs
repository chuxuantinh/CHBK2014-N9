...
{
    public partial class xfmAllowanceAdd : XtraForm
    {

        public RowClickEventArgs m_RowClickEventArgs;
        public xfmAllowanceAdd()
        {
            InitializeComponent();
        ...
        public xfmAllowanceAdd(Actions Action, DIC_ALLOWANCE Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.AllowanceCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucAllowanceAdd.SuccessEventHander(this.ucAdd_Success);
            this.Text = "";
        }
        ...
        public void RaiseAddedEventHander(DIC_ALLOWANCE Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_ALLOWANCE Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_ALLOWANCE Item)
        {
        ...
        public event xfmAllowanceAdd.AddedEventHander Added;

        public event xfmAllowanceAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_ALLOWANCE Item);

        public delegate void UpdatedEventHander(object sender, DIC_ALLOWANCE Item);
