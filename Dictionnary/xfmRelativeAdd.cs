...
{
    public partial class xfmRelativeAdd : XtraForm
    {

        public RowClickEventArgs m_RowClickEventArgs;
      

        public xfmRelativeAdd()
        {
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucRelativeAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        public void RaiseAddedEventHander(DIC_RELATIVE Item)
        {
            if (this.Added != null)
            {
        ...
        public event xfmRelativeAdd.AddedEventHander Added;

        public event xfmRelativeAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_RELATIVE Item);

        public delegate void UpdatedEventHander(object sender, DIC_RELATIVE Item);
