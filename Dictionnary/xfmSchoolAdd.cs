...
{
    public partial class xfmSchoolAdd : Form
    {
        ...
        public xfmSchoolAdd(Actions Action)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            DIC_SCHOOL dICSCHOOL = new DIC_SCHOOL();
            this.ucAdd.SetData(dICSCHOOL.NewID());
            this.Text = "Thêm";
        }

        public xfmSchoolAdd(Actions Action, DIC_SCHOOL Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.SchoolCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucSchoolAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        private void ucAdd_Success(object sender, DIC_SCHOOL Item)
        {
        ...
        public event xfmSchoolAdd.AddedEventHander Added;

        public event xfmSchoolAdd.UpdatedEventHander Updated;
