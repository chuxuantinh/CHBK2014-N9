...
{
    public partial class xfmNationalityAdd : XtraForm
    {
        public RowClickEventArgs m_RowClickEventArgs;
        public xfmNationalityAdd()
        {
            InitializeComponent();
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucNationalityAdd.SuccessEventHander(this.ucAdd_Success);
            this.Text = "";
        }
        ...
        public void RaiseAddedEventHander(DIC_NATIONALITY Item)
        {
            if (this.Added != null)
            {
        ...
        public event xfmNationalityAdd.AddedEventHander Added;

        public event xfmNationalityAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_NATIONALITY Item);

        public delegate void UpdatedEventHander(object sender, DIC_NATIONALITY Item);
    }
}
