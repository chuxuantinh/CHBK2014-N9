...
{
    public partial class xucJob : xucBaseBasic
    {
        public xucJob()
        {
            InitializeComponent();
        ...
        private void AddRow(DIC_JOB Item)
        {
            ...
            advBandedGridView.SetRowCellValue(focusedRowHandle, "JobCode", Item.JobCode);
            advBandedGridView.SetRowCellValue(focusedRowHandle, "JobName", Item.JobName);
        ...
        public override void Delete()
        {
            ...
            if (!(MyRule.Get(MyLogin.RoleId, "bbiJob") != "OK"))
            {
                if (MyRule.AllowDelete)
                {
                    ...
                    {
                        flag = true;
                        cellValue = base.GetCellValue(selectedRows[i - 1], "JobCode");
                        if (cellValue != null)
                        {
                           // SYS_LOG.Insert("Danh Mục Công Việc", "Xoá", cellValue.ToString());
                            str = dICJOB.Delete(cellValue.ToString());
                            if (str == "OK")
                            {
                    ...
                    if (!flag)
                    {
                        if (advBandedGridView.DataSource != null)
                        {
                            ...
                            cellValue = null;
                            cellValue = base.GetCellValue(rowClickEventArg.RowIndex, "JobCode");
                            if (cellValue != null)
                            {
                              //  SYS_LOG.Insert("Danh Mục Công Việc", "Xoá", cellValue.ToString());
                                base.SetWaitDialogCaption("Đang xóa...");
        ...
        protected override bool ExportPermision()
        {
            ...
            {
              //  SYS_LOG.Insert("Danh Mục Công Việc", "Xuất");
        ...
        private void frm_Added(object sender, DIC_JOB e)
        {
            this.AddRow(e);
        }

        private void frm_Updated(object sender, DIC_JOB Item)
        {
        ...
        protected override void gbList_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            RowClickEventArgs rowClickEventArg = new RowClickEventArgs((advBandedGridView == null ? -1 : advBandedGridView.FocusedRowHandle), (advBandedGridView.FocusedColumn == null ? -1 : advBandedGridView.FocusedColumn.ColumnHandle), (advBandedGridView.FocusedColumn == null ? "" : advBandedGridView.FocusedColumn.FieldName));
            this.m_RowClickEventArgs = rowClickEventArg;
            object cellValue = base.GetCellValue(rowClickEventArg.RowIndex, "JobCode");
        ...
        protected override void Print()
        {
            if (!(MyRule.Get(MyLogin.RoleId, "bbiJob") != "OK"))
            {
                ...
                {
                //    SYS_LOG.Insert("Danh Mục Công Việc", "In");
                    base.Print();
                }
                else
                {
        ...
        public override void ReLoad()
        {
            ...
            DIC_JOB dICJOB = new DIC_JOB();
            this.gcList.DataSource = dICJOB.GetList();
        ...
        private void UpdateRow(DIC_JOB item, RowClickEventArgs e)
        {
            AdvBandedGridView advBandedGridView = this.gbList;
            int rowIndex = e.RowIndex;
            advBandedGridView.SetRowCellValue(rowIndex, "Active", item.Active);
            advBandedGridView.SetRowCellValue(rowIndex, "JobCode", item.JobCode);
            advBandedGridView.SetRowCellValue(rowIndex, "JobName", item.JobName);
