...
{
    public partial class xfmUnitAdd : Form
    {
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucUnitAdd.SuccessEventHander(this.ucAdd_Success);
            this.Text = "";
        }
        ...
        public void RaiseAddedEventHander(DIC_UNIT Item)
        {
            if (this.Added != null)
            {
        ...
        public event xfmUnitAdd.AddedEventHander Added;

        public event xfmUnitAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_UNIT Item);

        public delegate void UpdatedEventHander(object sender, DIC_UNIT Item);
    }
}
