...
{
    public partial class xfmJobAdd : XtraForm
    {
        ...
        public xfmJobAdd(Actions Action)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            DIC_JOB dICJOB = new DIC_JOB();
            this.ucAdd.SetData(dICJOB.NewID());
            this.Text = "Tên";
        }

        public xfmJobAdd(Actions Action, DIC_JOB Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.JobCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucJobAdd.SuccessEventHander(this.ucAdd_Success);
            this.Text = "Job";
        }
        ...
        public void RaiseAddedEventHander(DIC_JOB Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_JOB Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_JOB Item)
        {
        ...
        public event xfmJobAdd.AddedEventHander Added;

        public event xfmJobAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_JOB Item);

        public delegate void UpdatedEventHander(object sender, DIC_JOB Item);
    }
}
