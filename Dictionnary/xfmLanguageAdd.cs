...
{
    public partial class xfmLanguageAdd : XtraForm
    {
        public RowClickEventArgs m_RowClickEventArgs;
  //   private xucLanguageAdd ucAdd = new xucLanguageAdd();
        public xfmLanguageAdd()
        {
            InitializeComponent();
        }

        public xfmLanguageAdd(Actions Action)
        {
            ...
            ucAdd.SetData(dICLANGUAGE.NewID());
            this.Text = "Thêm ";
        }

        public xfmLanguageAdd(Actions Action, DIC_LANGUAGE Item)
        {
            this.InitializeComponent();
            this.Init();
            ...
            {
                this.ucAdd.SetData(Item.LanguageCode);
            }
        }
        ...
        private void Init()
        {
          ...
          this.ucAdd.Success += new xucLanguageAdd.SuccessEventHander(this.ucAdd_Success);
            this.Text = "Cập nhật";
        }
        ...
        public void RaiseAddedEventHander(DIC_LANGUAGE Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_LANGUAGE Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_LANGUAGE Item)
        {
        ...
        public event xfmLanguageAdd.AddedEventHander Added;

        public event xfmLanguageAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_LANGUAGE Item);

        public delegate void UpdatedEventHander(object sender, DIC_LANGUAGE Item);

        private void xucBaseAdd1_Load(object sender, EventArgs e)
        {
