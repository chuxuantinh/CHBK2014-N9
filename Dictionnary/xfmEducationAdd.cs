...
{
    public partial class xfmEducationAdd : XtraForm
    {
        public RowClickEventArgs m_RowClickEventArgs;
        public xfmEducationAdd()
        {
            InitializeComponent();
        ...
        public xfmEducationAdd(Actions Action, DIC_EDUCATION Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.EducationCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucEducationAdd.SuccessEventHander(this.ucAdd_Success);
            this.Text = "Education";
        }
        ...
        public void RaiseAddedEventHander(DIC_EDUCATION Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_EDUCATION Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_EDUCATION Item)
        {
        ...
        public event xfmEducationAdd.AddedEventHander Added;

        public event xfmEducationAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_EDUCATION Item);

        public delegate void UpdatedEventHander(object sender, DIC_EDUCATION Item);
    }
}
