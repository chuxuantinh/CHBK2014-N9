...
{
    public partial class xfmRankAdd : XtraForm
    {
        ...
        public xfmRankAdd(Actions Action)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            DIC_SALARY_RANK dICSALARYRANK = new DIC_SALARY_RANK();
            this.ucAdd.SetData(dICSALARYRANK.NewID());
            this.Text = "Thêm";
        }

        public xfmRankAdd(Actions Action, DIC_SALARY_RANK Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucRankAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        public void RaiseAddedEventHander(DIC_SALARY_RANK Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_SALARY_RANK Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_SALARY_RANK Item)
        {
        ...
        public event xfmRankAdd.AddedEventHander Added;

        public event xfmRankAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_SALARY_RANK Item);

        public delegate void UpdatedEventHander(object sender, DIC_SALARY_RANK Item);
