...
{
    public partial class xfmDegreeAdd : Form
    {
        ...
        public xfmDegreeAdd(Actions Action)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            DIC_DEGREE dICDEGREE = new DIC_DEGREE();
            this.ucAdd.SetData(dICDEGREE.NewID());
            this.Text = "Thêm";
        }

        public xfmDegreeAdd(Actions Action, DIC_DEGREE Item)
        {
            this.InitializeComponent();
            this.Init();
            this.ucAdd.Status = Action;
            ...
            {
                this.ucAdd.SetData(Item.DegreeCode);
            }
        }
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucDegreeAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        public void RaiseAddedEventHander(DIC_DEGREE Item)
        {
            if (this.Added != null)
            {
        ...
        public void RaiseUpdatedEventHander(DIC_DEGREE Item)
        {
        ...
        private void ucAdd_Success(object sender, DIC_DEGREE Item)
        {
        ...
        public event xfmDegreeAdd.AddedEventHander Added;

        public event xfmDegreeAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_DEGREE Item);

        public delegate void UpdatedEventHander(object sender, DIC_DEGREE Item);
    }
}
