...
{
    public partial class xfmState : XtraForm
    {
        ...
        private void Init()
        {
           // SYS_LOG.Insert("Danh Mục Công Đoạn", "Xem");
        ...
        public event xfmState.ItemSelectedEventHander ItemSelected;
