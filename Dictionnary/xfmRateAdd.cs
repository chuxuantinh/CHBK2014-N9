...
{
    public partial class xfmRateAdd : XtraForm
    {
        ...
        private void Init()
        {
            ...
            this.ucAdd.Success += new xucRateAdd.SuccessEventHander(this.ucAdd_Success);
        ...
        public void RaiseAddedEventHander(DIC_RATE Item)
        {
            if (this.Added != null)
            {
        ...
        public event xfmRateAdd.AddedEventHander Added;

        public event xfmRateAdd.UpdatedEventHander Updated;

        public delegate void AddedEventHander(object sender, DIC_RATE Item);

        public delegate void UpdatedEventHander(object sender, DIC_RATE Item);
    }
}
