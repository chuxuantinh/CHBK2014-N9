...
{
    public partial class rptContract0 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public rptContract0(string ContractCode, string EmployeeCode)
        {
        ...
        private void rptContract_BeforePrint(object sender, PrintEventArgs e)
        {
            ...
            this.txtCompany.Text = "Tên Cty ABC";
