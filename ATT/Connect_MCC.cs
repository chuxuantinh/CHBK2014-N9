...
{
    public partial class Connect_MCC : Form
    {
        public Connect_MCC()
        {
            InitializeComponent();
        ...
        private void BindToGridView(object list)
        {
            ...
            CHBK2014_N9.ATT.Utilities.UniversalStatic.ChangeGridProperties(dgvRecords);
        }
        ...
        { CHBK2014_N9.ATT.Utilities.UniversalStatic.DrawLineInFooter(pnlHeader, Color.FromArgb(204, 204, 204), 2); }
        ...
        { CHBK2014_N9.ATT.Utilities.UniversalStatic.ValidateInteger(tbxPort); }

        private void tbxMachineNumber_TextChanged(object sender, EventArgs e)
        { CHBK2014_N9.ATT.Utilities.UniversalStatic.ValidateInteger(tbxMachineNumber); }
        ...
        private void Connect_MCC_Load(object sender, EventArgs e)
        {
