...
namespace CHBK2014_N9
{
    public partial class frmChamCong_BangXepCa : DevExpress.XtraEditors.XtraForm
    {
        public frmChamCong_BangXepCa()
        {
            ...
            // su dung goi pro CT_TIMEKEEPER_SHIFT_UpdateNewEmployee();
        }
        ...
        private void frmChamCong_BangXepCa_Load(object sender, EventArgs e)
        {
         ...
         //   kiemtraDuLieuTruockhiloadForm(_Month, _Year);
          ...
          _TimeKeeperTableListID = CT_TIMEKEEPER_TABLELIST_Get();
          ...
          //dtBXC = bxc.CT_TIMEKEEPER_SHIFT_GetList();
        ...
        private string CT_TIMEKEEPER_TABLELIST_Get()
        {
            ...
            DataTable dt = xc.CT_TIMEKEEPER_TABLELIST_Get();
            if (dt.Rows.Count > 0)
            {
        ...
        private void xulyloaddsNhanVien(string Dl)
        {
            ...
            if (Dl == "0") // load tat ca
            {
                ...
                //dtBXC = bxc.CT_TIMEKEEPER_SHIFT_GetList();        
                //gridItem.DataSource = dtBXC;
                //gridItem.DataSource = bxc.CT_TIMEKEEPER_SHIFT_GetList();
            ...
            else if (Dl.IndexOf("CN") > -1)
            {
                ...
                //bxc.BranchCode = Dl;
                //dtBXC.Clear();
                //dtBXC = bxc.CT_TIMEKEEPER_SHIFT_GetListByBranch(); 
                //gridItem.DataSource = dtBXC;
                if (dtBXC.Rows.Count > 0)
                {
                    DataView dv = new DataView();
            ...
            else if (Dl.IndexOf("PB") > -1)
            {
                ...
                //dtBXC.Clear();
                //dtBXC = bxc.CT_TIMEKEEPER_SHIFT_GetListByDepartment();   
                //gridItem.DataSource = dtBXC;
               // gridItem.DataSource = bxc.CT_TIMEKEEPER_SHIFT_GetListByDepartment();
                if (dtBXC.Rows.Count > 0)
                {
                    DataView dv = new DataView();
                    dv = dtBXC.DefaultView;
            ...
            else
            {
                ...
                //bxc.GroupCode = Dl;
                //dtBXC.Clear();
                //dtBXC = bxc.CT_TIMEKEEPER_SHIFT_GetListByGroup();
                //gridItem.DataSource = dtBXC;
               // gridItem.DataSource = bxc.CT_TIMEKEEPER_SHIFT_GetListByGroup();
                if (dtBXC.Rows.Count > 0)
                {
                    DataView dv = new DataView();
                    dv = dtBXC.DefaultView;
        ...
        private void btnSelect_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                DataTable dtTempCheck = bxc.CT_TIMEKEEPER_TABLELIST_GetByID();
                if (dtTempCheck.Rows.Count > 0)
                {
                    if ((bool)dtTempCheck.Rows[0]["IsFinish"] == false)
                    {
                        ...
                        {
                            bxc.CT_TIMEKEEPER_SHIFT_UpdateNewEmployee();  // update neu nhan vien nhap sau khi bang cham cong duoc tao
                        }
                    }
                }
            }
        ...
        private void btnReset_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    if (bxc.CT_TIMEKEEPER_TABLELIST_Reset())
                    {
        ...
        private void contextMenuStrip1_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
            if (gridItemDetail.FocusedRowHandle < 0)
              ...
              string data = Clipboard.GetText().Trim();
                ...
                string _GroupName = gridItemDetail.GetRowCellValue(gridItemDetail.FocusedRowHandle, colGroupName).ToString();
                string _DepartmentName = gridItemDetail.GetRowCellValue(gridItemDetail.FocusedRowHandle, colDepartmentName).ToString();
                if (_GroupName.Trim().Length > 0)
                {
                    if (_GroupName.Trim().ToLower().Contains("t1"))
                    {
                        btnCaBaoTri.Enabled = false;
                        btnCaCS.Enabled = false;
                        btnCaThuNgan.Enabled = false;
                        btnDieuPhoi.Enabled = true;
                        btnCaBBS2.Enabled = false;
                        btnCaillegal.Enabled = false;
                        btnCanvQ2Q9.Enabled = false;

                       
                    }
                    else if (_GroupName.Trim().ToLower().Contains("t2"))
                    {
                        btnCaBaoTri.Enabled = true;
                        btnCaCS.Enabled = false;
                        btnCaThuNgan.Enabled = false;
                    ...
                    else if (_GroupName.Trim().ToLower().Contains("t3"))
                    {
                        btnCaBaoTri.Enabled = false;
                        btnCaCS.Enabled = false;
                        btnCaThuNgan.Enabled = false;
                        btnDieuPhoi.Enabled = false;
                        btnCaBBS2.Enabled = false;
                        btnCaillegal.Enabled = true;
                        btnCanvQ2Q9.Enabled = false;
                    }
                    else if (_GroupName.Trim().ToLower().Contains("2&9"))
                    {
                        btnCaBaoTri.Enabled = false;
                        btnCaCS.Enabled = false;
                        btnCaThuNgan.Enabled = false;
                        ...
                        btnCaBBS2.Enabled = false;
                        btnCaillegal.Enabled = false;
                        btnCanvQ2Q9.Enabled = true;
                    }
                }
                else
                {
                    if (_DepartmentName.Trim().ToLower().Contains("t4"))
                    {
                        btnCaBaoTri.Enabled = false;
                        btnCaCS.Enabled = true;
                        btnCaThuNgan.Enabled = false;
                    ...
                    else if (_DepartmentName.Trim().ToLower().Contains("t5"))
                    {
                        btnCaBaoTri.Enabled = false;
                        btnCaCS.Enabled = false;
                        btnCaThuNgan.Enabled = true;
                    ...
                    else if (_DepartmentName.Trim().ToLower().Contains("t6"))
                    {
                        btnCaBaoTri.Enabled = false;
                        btnCaCS.Enabled = false;
                        btnCaThuNgan.Enabled = false;
                    ...
                    else if (_DepartmentName.Trim().ToLower().Contains("t7"))
                    {
                        btnCaBaoTri.Enabled = false;
                        btnCaCS.Enabled = false;
                        btnCaThuNgan.Enabled = false;
                    ...
                    else if (_DepartmentName.Trim().ToLower().Contains("t9"))
                    {
                        btnCaBaoTri.Enabled = false;
                        btnCaCS.Enabled = false;
                        btnCaThuNgan.Enabled = true;
