...
namespace CHBK2014_N9
{
    public partial class frmDanhSachNhanVien : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnAddPB_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            frmDanhMuc_PhongBan_Update frm = new frmDanhMuc_PhongBan_Update(true, "Thêm Phòng ban", "PB", null, "frmDanhSachNhanVien");
            frm.Owner = this;
            frm.ShowDialog();
        }
        ...
        private void btnAddNV_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            frmEmployee_Update frm = new frmEmployee_Update(true, "Thêm nhân viên ", null, null, "frmDanhSachNhanVien");
            frm.Owner = this;
            Waiting.CloseWaitForm();
            frm.ShowDialog();
            this.Activate();
        ...
        private void contextMenuStrip1_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            if (gridItem.MainView == gridItemDetail)
            {
                ...
                DataTable dttv = nvtv.CT_EMPLOYEE_DEACTIVE_GetByEmployeeCode();
        ...
        private void btnThuyenChuyenNhanVien_Click(object sender, EventArgs e)
        {
            if (gridItemDetail.SelectedRowsCount > 0)
            {
                ...
                frmQuaTrinh_ChucVu_New frm = new frmQuaTrinh_ChucVu_New("Fast", result, dtnv, _name);
                frm.Owner = this;
                frm.ShowDialog();
            }
            if (layoutItemDetail.SelectedRowsCount > 0)
        ...
        private void btnInQDTV_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = nvtv.CT_EMPLOYEE_DEACTIVE_GetPrint();
            if (dt.Rows.Count > 0)
            {
                string _boPhan = "";
                string _sex = "";
                ...
                DataTable dthd = hd.CT_CONTRACT_GetCurrentListByEmployee();
